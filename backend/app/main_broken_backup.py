        ...
        for entry in entries:
            ...
            for change in changes:
                ...
                for message in messages:
                    ...
                    # =============================================
# RECORD WHATSAPP RESPONSE ENGAGEMENT
# =============================================
...
try:
    ...
    try:
        ...
        # Find the campaign recipient using the sender phone number
        recipient_result = await db.execute(
            select(CampaignRecipient)
            .join(
                AudienceMember,
        ...
        if campaign_recipient:
            ...
            if delivery:
                ...
                event = EngagementEvent(
                    ...
                    event_type=EngagementType.RESPONSE,
                ...
                print(
                    "WhatsApp RESPONSE engagement recorded."
                )

            else:

                print(
                    "No WhatsApp delivery found "
                    "for response engagement."
                )

        else:

            print(
                "No campaign recipient found "
                f"for WhatsApp sender: {sender}"
            )
    ...
    print(
        "WARNING: Could not record WhatsApp "
        "response engagement:"
    )
